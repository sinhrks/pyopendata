    ...
    def test_mining_manufacture(self):
        ...
        expected = {
            '在庫': np.array(['2A00000000', '製造工業', 9988.1,
                ...
                98.7, 100.5, 107.2, 108.7, 112.6, 114.5], dtype=object),
            '出荷': np.array(['2A00000000', '製造工業', 9985.7,
                ...
                98.3, 113.9, 93.4, 90.9, 98.5, 101.6, 87.8], dtype=object),
            '生産': np.array(['2A00000000', '製造工業',
                ...
                97, 104.1, 92.1, 102.2, 102.3, 99.8, 100, 96.1, 97.8, 110, 96.3, 94, 100, 103.4, 89.1],
                dtype=object)}
